  ...
  return (
    <div className="flex flex-col gap-4 text-left">
      <section>
        ...
        <ul className="flex flex-col gap-1 text-sm leading-relaxed text-ink-secondary">
      ...
      <section>
        ...
        <ul className="flex flex-col gap-1 text-sm leading-relaxed text-ink-secondary">
          <li>
            · <span className="font-medium text-ink-primary">显式标识</span>
            ：插画右下角「AI 绘制」小角标，动画右下角「AI 动画」小角标
          </li>
          <li>
            · <span className="font-medium text-ink-primary">隐式标识</span>
      ...
      <p className="text-xs leading-relaxed text-ink-secondary/70">
